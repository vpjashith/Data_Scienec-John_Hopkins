...
# Plot 1
plot(x = dataset$datetime,y = dataset$Global_active_power,type = "l", xlab="", ylab="Global Active Power")

# Plot 2
plot(x = dataset$datetime,y = dataset$Voltage,type = "l", xlab="", ylab="Voltage")
...
# Plot 4
plot(x = dataset$datetime,y = dataset$Global_reactive_power,type = "l", xlab="", ylab="Energy sub metering")
